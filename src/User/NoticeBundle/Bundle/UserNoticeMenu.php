...
class UserNoticeMenu
{
    ...
    public function inflateUserMenu(Menu $menu)
    {
        ...
        $sub_menu_1->setUrl($this->router->generate('user_notice_message'));
        $sub_menu_1->setIcon('circle-o');
        $sub_menu_1->setTags([
            'user_notice_message',
            'user_notice_message_read'
        ]);
        ...
        $sub_menu_2->setUrl($this->router->generate('user_notice_notification'));
        $sub_menu_2->setIcon('circle-o');
        $sub_menu_2->setTags([
            'user_notice_notification'
        ]);
